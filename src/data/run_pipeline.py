...
if __name__ == "__main__":
    ...
    print(f'Project root folder set to: {project_root_folder}')

    # Set up paths to data folders
    raw_data_folder_path  = os.path.join(project_root_folder, 'data', 'raw')
    processed_data_folder_path  = os.path.join(project_root_folder, 'data', 'processed')
